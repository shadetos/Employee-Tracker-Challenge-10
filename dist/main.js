    ...
    mainChoices() {
        inquirer
            .prompt([
            {
                type: 'list',
                name: 'ReadOrWrite',
                message: 'Would you like to Create a new employee or view existing ones?',
    ...
    createEmployee() {
        inquirer
            ...
            },
            {
                ...
                message: "Does your employee have a manager (please provide manager id)?",
            }
        ])
            .then((employeeData) => {
            this.insert(`
    ...
    updateEmployeeRole() {
        inquirer
            .prompt([
            {
                type: 'input',
                name: 'employeeId',
                message: "what is the id of the employee your trying to edit?",
            },
            {
                type: 'input',
                name: 'roleId',
    ...
    createRole() {
        inquirer
            .prompt([
            {
                type: 'input',
                name: 'newRoll',
                message: "What is the name of your New roll?"
            },
            {
                type: 'input',
                name: 'rollSalary',
